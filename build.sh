...
MAPPED_WEB_PORT=82
MAPPED_NGINX_PORT443=4445
CONTAINER_NAME="pinguo_${SYSTEM_NAME}_newdev"
IMAGE_TAG="pinguo/${SYSTEM_NAME}:newdev"
CONTAINER_HOSTNAME="newdev"
CARGS=" -d -p $MAPPED_SSH_PORT:22 -p $MAPPED_WEB_PORT:8000 -p $MAPPED_NGINX_PORT443:443"
CARGS="$CARGS --link rabbitmq --hostname=$CONTAINER_HOSTNAME --name $CONTAINER_NAME "
